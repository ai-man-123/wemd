...
//Fake Reply Group
	const reply = (teks) => {
            zaki.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Instagramメ`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/zaki.jpg`),"sourceUrl": "https://instagram.com/aiman1_23"}}}, { quoted: m})
        }
        
        const reply1 = (teks) => {
            zaki.sendMessage(m.chat, { text: teks, contextInfo:{"externalAdReply": {"title": ` ${global.botnma}`,"body": ` Githubメ`, "previewType": "PHOTO","thumbnailUrl": ``,"thumbnail": fs.readFileSync(`./media/zaki.jpg`),"sourceUrl": "https://github.com/ai-man-123/wemd"}}}, { quoted: m})
        }
...
m.reply(`Successfully Reported To The Owner\n\nPlease Make Sure The Bug Is Valid, If You Play With This, Use This Feature Again And Again For No Reason, You Will Be Blocked For Sure !`)
                    ...
                    break 
case 'tes': case 'test': case 'alive': case 'bot': case 'robot': case 'lynx': case 'doge':{
                anu = `Hi ${pushname} 🤚`
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
                    templateMessage: {
                        hydratedTemplate: {
                            ...
                            hydratedFooterText: `𝙸 𝙰𝚖 lynx𝚇𝙳 | © 2022`,
                            hydratedButtons: [{
                                urlButton: {
...
//━━━━━━━━━━━━━━━[ MENU LOC ]━━━━━━━━━━━━━━━\\
const template = generateWAMessageFromContent(m.chat, proto.Message.fromObject({ templateMessage: { hydratedTemplate: { hydratedContentText: anu.trim(), locationMessage: { jpegThumbnail: fs.readFileSync('./media/menu.jpg') }, hydratedFooterText: `Lynx.man !`, hydratedButtons: [{ urlButton: { displayText: 'Instagramメ', url: 'https://instagram.com/aiman1_23'} }, { urlButton: { displayText: 'Website ownerメ', url: 'http://surl.li/dijcc'} }, { quickReplyButton: { displayText: 'Owner', id: 'owner', } }, { quickReplyButton: { displayText: 'Speedメ', id: 'ping', } }] } } }), { userJid: m.sender, quoted: m }); //conn.reply(m.chat, text.trim(), m) 
  zaki.relayMessage( m.chat, template.message, { messageId: template.key.id } )
...
case 'owner': case 'creator': {
    ...
    + 'FN:lynx.man\n'
    + 'ORG:LynxAiman;\n' //Nama Kalian
    + 'item1.TEL;type=CELL;type=VOICE;waid=60102810046:+60 10-281 0046\n' //Nomor Kalian
    + 'item1.X-ABLabel:Creator lynxbot  - MDt\n' //Info Kalian
...
break
case 'script': case 'sc':
                m.reply('```Script Update From : https://github.com/ai-man-123/wemd')
break
	    case 'donasi': case 'donate': case 'sewabot': case 'sewa': case 'buypremium': case 'donate': {
                zaki.sendMessage(m.chat, { image: { url: '-' }, caption: `*── 「 DONATE 」 ──*\n\n_Kalian Bisa Dukung Bot Lewat Donate Ke :_\n _》Dana : 00102810046_\n _》Gopay : 0102810046_\n _》Pulsa : 0102810046 ( digi )_\n\n_Donate Kalian Sangat Berarti._\n\n_Contact person Owner:_\n_wa.me/60102810046_` }, { quoted: m })
            }
            break
            default:
                if (budy.startsWith('=>')) {
